/**
 * 中国行政区划代码表
 * 省级 34 + 地级行政区 340+，边界由阿里云 DataV bound/{adcode}.json 提供
 * 数据来源：民政部 GB/T 2260 行政区划代码
 */
...
export const CITY_GROUPS = [
  { province: '河北省', adcode: '130000', cities: [
  ...
  { province: '辽宁省', adcode: '210000', cities: [
  ...
  { province: '江苏省', adcode: '320000', cities: [
  ...
  { province: '河南省', adcode: '410000', cities: [
    ...
    ['南阳市', '411300'], ['商丘市', '411400'], ['信阳市', '411600'], ['周口市', '411700'],
    ['驻马店市', '411900'],
  ]},
  { province: '湖北省', adcode: '420000', cities: [
  ...
  { province: '湖南省', adcode: '430000', cities: [
  ...
  { province: '广东省', adcode: '440000', cities: [
  ...
  { province: '广西壮族自治区', adcode: '450000', cities: [
  ...
  { province: '海南省', adcode: '460000', cities: [
    ['海口市', '460100'], ['三亚市', '460200'], ['三沙市', '460300'], ['儋州市', '460400'],
  ]},
  { province: '四川省', adcode: '510000', cities: [
    ...
    ['巴中市', '511900'], ['资阳市', '512000'], ['阿坝藏族羌族自治州', '513200'],
    ['甘孜藏族自治州', '513300'], ['凉山彝族自治州', '513400'],
  ]},
  { province: '贵州省', adcode: '520000', cities: [
    ['贵阳市', '520100'], ['六盘水市', '520200'], ['遵义市', '520300'], ['安顺市', '520400'],
    ['毕节市', '520500'], ['铜仁市', '520600'], ['黔西南布依族苗族自治州', '522300'],
    ['黔东南苗族侗族自治州', '522600'], ['黔南布依族苗族自治州', '522700'],
  ]},
  { province: '云南省', adcode: '530000', cities: [
  ...
  { province: '青海省', adcode: '630000', cities: [
    ['西宁市', '630100'], ['海东市', '630200'], ['海北藏族自治州', '632200'],
    ['黄南藏族自治州', '632300'], ['海南藏族自治州', '632500'], ['果洛藏族自治州', '632600'],
    ['玉树藏族自治州', '632700'], ['海西蒙古族藏族自治州', '632800'],
  ]},
  { province: '宁夏回族自治区', adcode: '640000', cities: [
    ['银川市', '640100'], ['石嘴山市', '640200'], ['吴忠市', '640300'], ['固原市', '640400'],
    ['中卫市', '640500'],
  ]},
  { province: '新疆维吾尔自治区', adcode: '650000', cities: [
    ...
    ['伊犁哈萨克自治州', '654000'], ['塔城地区', '654200'], ['阿勒泰地区', '654300'],
  ]},
]

// ─── 扁平化：所有地级行政区（供搜索） ───
export const CITIES = CITY_GROUPS.flatMap(g =>
  g.cities.map(([name, adcode]) => ({
    name, adcode, level: 'city', parent: g.province, parentAdcode: g.adcode,
  }))
)

// ─── 全部区域（省 + 市，供搜索） ───
export const ALL_AREAS = [
  ...PROVINCES.map(p => ({ ...p, level: 'province' })),
  ...CITIES,
]

// 直辖市（无下级地级市，直接用省级边界）
export const MUNICIPALITIES = new Set(['110000', '120000', '310000', '500000'])
